...
export default function HomePage() {
  return (
    <>
      <div className=" flex flex-col lg:flex-row w-full pt-40 px-4 md:px-6 lg:px-10">
        <div className="flex-[3] px-4 md:px-6 lg:px-10 flex flex-col justify-center ">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-md p-6">
            <p className="mb-6 text-base md:text-lg font-normal text-body">
              I'm a full-stack software engineer specializing in .NET Core,
              React, and modern cloud-native systems. I love solving complex
              problems, whether it's migrating legacy data, improving system
              performance, or building clean, intuitive interfaces. I'm driven
              by curiosity, reliability, and a desire to build software that
              genuinely makes things better, and I am always looking for new
